...
dict set ap_memory_interface_dict OutConv5 { MEM_WIDTH 16 MEM_SIZE 2560 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict OutPool2 { MEM_WIDTH 16 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ OutConv5 int 16 regular {array 1280 { 1 1 } 1 1 }  }
	{ OutPool2 int 16 regular {array 640 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "OutConv5", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "OutPool2", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "OutConv5_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "OutConv5", "role": "q0" }} , 
 	...
 	{ "name": "OutConv5_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "OutConv5", "role": "q1" }} , 
 	...
 	{ "name": "OutPool2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "OutPool2", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	OutConv5 { ap_memory {  { OutConv5_address0 mem_address 1 11 }  { OutConv5_ce0 mem_ce 1 1 }  { OutConv5_q0 mem_dout 0 16 }  { OutConv5_address1 MemPortADDR2 1 11 }  { OutConv5_ce1 MemPortCE2 1 1 }  { OutConv5_q1 MemPortDOUT2 0 16 } } }
	OutPool2 { ap_memory {  { OutPool2_address0 mem_address 1 10 }  { OutPool2_ce0 mem_ce 1 1 }  { OutPool2_we0 mem_we 1 1 }  { OutPool2_d0 mem_din 1 16 } } }
}
