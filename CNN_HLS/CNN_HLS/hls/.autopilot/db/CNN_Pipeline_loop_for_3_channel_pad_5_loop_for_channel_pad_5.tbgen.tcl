...
dict set ap_memory_interface_dict OutPadConv5 { MEM_WIDTH 16 MEM_SIZE 2688 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict OutConv4 { MEM_WIDTH 16 MEM_SIZE 2560 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ OutPadConv5 int 16 regular {array 1344 { 0 3 } 0 1 }  }
	{ OutConv4 int 16 regular {array 1280 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "OutPadConv5", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "OutConv4", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "OutPadConv5_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "OutPadConv5", "role": "d0" }} , 
 	...
 	{ "name": "OutConv4_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "OutConv4", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	OutPadConv5 { ap_memory {  { OutPadConv5_address0 mem_address 1 11 }  { OutPadConv5_ce0 mem_ce 1 1 }  { OutPadConv5_we0 mem_we 1 1 }  { OutPadConv5_d0 mem_din 1 16 } } }
	OutConv4 { ap_memory {  { OutConv4_address0 mem_address 1 11 }  { OutConv4_ce0 mem_ce 1 1 }  { OutConv4_q0 mem_dout 0 16 } } }
}
