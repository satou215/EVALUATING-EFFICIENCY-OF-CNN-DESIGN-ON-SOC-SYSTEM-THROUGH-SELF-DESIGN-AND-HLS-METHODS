...
dict set ap_memory_interface_dict OutPadConv0 { MEM_WIDTH 16 MEM_SIZE 648 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
