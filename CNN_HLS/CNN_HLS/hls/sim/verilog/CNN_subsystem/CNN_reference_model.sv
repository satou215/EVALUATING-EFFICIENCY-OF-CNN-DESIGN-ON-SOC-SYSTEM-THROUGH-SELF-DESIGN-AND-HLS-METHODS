...
`ifndef CNN_REFERENCE_MODEL_SV
`define CNN_REFERENCE_MODEL_SV

class CNN_reference_model extends uvm_component;
    ...
    `uvm_component_utils_begin(CNN_reference_model)
