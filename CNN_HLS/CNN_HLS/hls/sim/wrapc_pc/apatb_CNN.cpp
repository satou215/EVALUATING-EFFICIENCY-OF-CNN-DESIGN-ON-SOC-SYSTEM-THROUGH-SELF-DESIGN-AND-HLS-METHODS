...
#define AUTOTB_TVIN_OutModel "../tv/cdatafile/c.CNN.autotvin_OutModel.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_OutModel "../tv/rtldatafile/rtl.CNN.autotvout_OutModel.dat"
...
extern "C"
void apatb_CNN_hw(void* __xlx_apatb_param_InModel, void* __xlx_apatb_param_OutModel, void* __xlx_apatb_param_Weights)
{
  static hls::sim::Register port0 {
    .name = "OutModel",
    .width = 16,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_OutModel),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_OutModel),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_OutModel),
#endif
  };
  port0.param = __xlx_apatb_param_OutModel;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_InModel),
#else
  ...
  port1.param = { __xlx_apatb_param_InModel };
  port1.mname = { "InModel" };
  port1.nbytes = { 640 };
  ...
  try {
    ...
    CNN_hw_stub_wrapper(__xlx_apatb_param_InModel, __xlx_apatb_param_OutModel, __xlx_apatb_param_Weights);
