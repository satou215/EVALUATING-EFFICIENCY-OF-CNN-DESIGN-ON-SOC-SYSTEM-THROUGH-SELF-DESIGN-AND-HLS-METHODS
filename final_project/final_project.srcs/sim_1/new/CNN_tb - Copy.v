...
module CNN_tb;
  ...
  wire                          complete_out;
  // Outputs
  wire signed [`DATA_WIDTH-1:0] AXI_LDM_douta_out;
  ...
  assign AXI_LDM_douta_out = complete_out ? 4 : 0;
  // Memory declarations
  ...
  initial begin
    ...
    $readmemh("D:/Verilog/signals_label_A_hex.txt", ldm_mem);
    $readmemh("D:/Verilog/context.txt", context_mem);
