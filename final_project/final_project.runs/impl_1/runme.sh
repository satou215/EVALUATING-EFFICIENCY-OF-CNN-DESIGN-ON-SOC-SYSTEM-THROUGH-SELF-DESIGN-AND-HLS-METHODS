...
HD_PWD='D:/PJ/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CNN.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CNN.tcl -notrace
